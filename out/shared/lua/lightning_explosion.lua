...
local LightningBolt = require(game.ReplicatedStorage:WaitForChild('TS'):WaitForChild('lua'):WaitForChild('lightning_bolt'))
local LightningSparks = require(game.ReplicatedStorage:WaitForChild('TS'):WaitForChild('lua'):WaitForChild('lightning_sparks'));
